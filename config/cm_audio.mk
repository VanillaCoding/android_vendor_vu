...
ALARM_PATH := vendor/vu/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/vu/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/vu/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/vu/prebuilt/common/media/audio/ui
